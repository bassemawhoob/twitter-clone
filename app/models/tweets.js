...
TweetSchema.virtual("_retweets").set(function(user) {
  if (this.retweets.indexOf(user._id) === -1) {
    this.retweets.push(user._id);
  } else {
    this.retweets.splice(this.retweets.indexOf(user._id), 1);
  }
});
